...
## @type: DataSource
## @args: [database = "source-sensor-events-database", table_name = "source_sensor_events_buckett", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(
    database="source-sensor-events-database",
    table_name="source_sensor_events_buckett",
...
## @type: DataSink
## @args: [catalog_connection = "redshift", connection_options = {"dbtable": "source_sensor_events_buckett", "database": "db"}, redshift_tmp_dir = TempDir, transformation_ctx = "datasink4"]
## @return: datasink4
## @inputs: [frame = dropnullfields3]
datasink4 = glueContext.write_dynamic_frame.from_jdbc_conf(
    frame=dropnullfields3,
    catalog_connection="redshift",
    connection_options={"dbtable": "source_sensor_events_buckett", "database": "db"},
